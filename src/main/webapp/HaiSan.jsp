                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="#" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input class="form-control" type="text" name="firstname" id="firstname" placeholder="Nhập họ" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input class="form-control" type="text" name="lastname" id="lastname" placeholder="Nhập tên" required>
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <input class="form-control" type="text" name="uname" id="uname" placeholder="Nhập tên tài khoản" required>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input class="form-control" type="password" name="pwd" id="pwd" placeholder="Nhập mật khẩu" required>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-label-group">
                                                <input class="form-control" type="password" name="rpwd" id="rpwd" placeholder="Nhập lại mật khẩu" required>
                                ...
                                <div class="form-group form-check">
                                    <label class="form-check-label" for="">
                                        <input class="form-check-input" type="checkbox" name="remember" required>Tôi đồng ý tất cả
                                        các điều khoản
                                        <div class="valid-feedback">Có hiệu lực</div>
                                        <div class="invalid-feedback">Vui lòng điền vào trường này</div>
                                    </label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-left">
                            <form action="/panel.html" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <input type="text" class="form-control" id="username" placeholder="Nhập tài khoản" name="email" required>
                                ...
                                <div class="form-group">
                                    <div class="form-label-group">
                                        <input type="password" class="form-control" id="pwdd" placeholder="Nhập mật khẩu" name="pswd" required>
...
<div class="bg-light">
    <div class="container-fluid" id="tag-tool">
        <div class="tag">
            ...
            <span>/</span>
            <a href="HaiSan.html" class="active" style="color: black;font-weight: bold;">HẢI SẢN</a>
        </div>
        <div class="searching">
            <form>
                ...
                <aside id="form-2">
                    ...
                    <ul class="list-group list-commoner">
                        <li class="list-group-item" style="width: 100%;float: left;">
                            <a href="">
                                <img style="width: 60px;height: 60px;float: left;" src="Image/cá basa.jpg" alt="img-1">
                                <span class="product-title">Cá basa</span>
                                <span class="d-block">75,000&nbsp;<span>₫</span></span>
                            </a>
                        </li>
                        <li class="list-group-item" style="width: 100%;float: left;">
                            <a href="">
                                <img style="width: 60px;height: 60px;float: left;" src="Image/tômhungf.jpg" alt="img-2">
                                <span class="product-title">Tôm hùng</span>
                                <span class="d-block">285,000&nbsp;<span>₫</span></span>
                            </a>
                        </li>
                        <li class="list-group-item" style="width: 100%;float: left;">
                            <a href="">
                                <img style="width: 60px;height: 60px;float: left;" src="Image/tômsú.jpg" alt="img-3">
                                <span class="product-title">Tôm sú</span>
                                <span class="d-block">180,000&nbsp;<span>₫</span></span>
                            </a>
                        </li>
                        <li class="list-group-item" style="width: 100%;float: left;">
                            <a href="">
                                <img style="width: 60px;height: 60px;float: left;" src="Image/cachep.jpg" alt="img-4">
                                <span class="product-title">Cá chép</span>
                                <span class="d-block">220,000&nbsp;<span>₫</span></span>
                            </a>
                        </li>
                        <li class="list-group-item" style="width: 100%;float: left;">
                            <a href="">
                                <img style="width: 60px;height: 60px;float: left;" src="Image/muc.jpg" alt="img-5">
                                <span class="product-title">Mực ống</span>
                                <span class="d-block">105,000&nbsp;<span>₫</span></span>
                            </a>
                        </li>
                    </ul>
                </aside>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <div class="row product-all">
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                        <div class="form-3">
                            <a href="">
                                <img style="width: 200px;height: 200px;" src="Image/cá basa.jpg" alt="">
                                <div class="BG-1">
                                    <span style="display:block;" class="name-label">Cá basa</span>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3">
                        <div class="form-3">
                            <a href="">
                                <img style="width: 200px;height: 200px;" src="Image/tômhungf.jpg" alt="">
                                <div class="BG-1">
                                    <span style="display:block;" class="name-label">Tôm hùng</span>
                                    <span class="price"><span>Giá:&nbsp;</span>285,000&nbsp;<span>₫</span></span>
                                </div>
                                <button type="button" name="" id="" class="btn btn-primary btn-lg center-post Mua">Mua Ngay</button>
                            </a>
                        </div>
                    ...
                    <div class="col-xs-3 col-sm-6 col-md-6 col-lg-3">
                        <div class="form-3">
                            <a href="">
                                <img style="width: 200px;height: 200px;" src="Image/tômsú.jpg" alt="">
                                <div class="BG-1">
                                    <span style="display:block;" class="name-label">Tôm sú</span>
                                    <span class="price"><span>Giá:&nbsp;</span>180,000&nbsp;<span>₫</span></span>
                                </div>
                                <button type="button" name="" id="" class="btn btn-primary btn-lg center-post Mua">Mua Ngay</button>
                            </a>
                        </div>
                    ...
                    <div class="col-xs-3 col-sm-6 col-md-6 col-lg-3">
                        <div class="form-3">
                            <a href="">
                                <img style="width: 200px;height: 200px;" src="Image/cachep.jpg" alt="">
                                <div class="BG-1">
                                    <span style="display:block;" class="name-label">Cá chép</span>
                                    <span class="price"><span>Giá:&nbsp;</span>220,000&nbsp;<span>₫</span></span>
                                </div>
                                <button type="button" name="" id="" class="btn btn-primary btn-lg center-post Mua">Mua Ngay</button>
                            </a>
                        </div>
                    ...
                    <div class="col-xs-3 col-sm-6 col-md-6 col-lg-3">
                        <div class="form-3">
                            <a href="">
                                <img style="width: 200px;height: 200px;" src="Image/muc.jpg" alt="">
                                <div class="BG-1">
                                    <span style="display:block;" class="name-label">Mực ống</span>
                                    <span class="price"><span>Giá:&nbsp;</span>105,000&nbsp;<span>₫</span></span>
                                </div>
                                <button type="button" name="" id="" class="btn btn-primary btn-lg center-post Mua">Mua Ngay</button>
                            </a>
                        </div>
...
<footer>
    ...
    <div class="all-element-footer">
        ...
        <div class="element-footer-info">
            ...
            <p><span><i class="fas fa-map-marker-alt"></i></span>193 Nguyễn Lương Bằng, Quận Liên Chiểu,<br>TP. Đà Nẵng</p>
