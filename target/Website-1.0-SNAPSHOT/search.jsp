        ...
        <div class="row">
            <div class="col-xs-0 col-sm-0 col-md-4 col-lg-3">
                ...
                <aside id="form-2">
                    ...
                    <ul class="list-group list-commoner">
                        <c:forEach items="${requestScope.search}" var="search" varStatus="loop">
                            <c:if test="${loop.index<5}">
                                <li class="list-group-item" style="width: 100%;float: left;">
                                    <a href="">
                                        <img style="width: 60px;height: 60px;float: left;" src="${search.imgurl}"
                                             alt="img-1">
                                        <span class="product-title">${search.name}</span>
                                        <span class="d-block">${search.price}&nbsp;<span>₫</span></span>
                                    </a>
                                </li>
                            </c:if>
                        </c:forEach>
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                <div class="row product-all">
                    <c:set var="checksearch" value="${requestScope.checksearch}" />
                    <c:if test="${checksearch != 0}">
                        <c:forEach items="${requestScope.search}" var="search">
                            <div class="col-xs-3 col-sm-6 col-md-6 col-lg-3">
                                <div class="form-3">
                                    <a href="">
                                        <img style="width: 200px;height: 200px;"
                                             src="${search.imgurl}" alt="">
                                        <div class="BG-1">
                                            <span style="display:block;" class="name-label">${search.name}</span>
                                            <span class="price"><span>Giá:&nbsp;</span>${search.price}&nbsp;<span>₫</span></span>
                                        </div>
                                            <%--                                    <button type="button" name="" id=""--%>
                                            <%--                                            class="btn btn-primary btn-lg center-post Mua">Mua Ngay</button>--%>
                                        <a class=" btn btn-primary btn-lg center-post" href="cart?id=${search.idproduct}" >Mua ngay</a>
                                    </a>
                                </div>
                            </div>
                        </c:forEach>
                ...
                <c:if test="${checksearch == 0}">
                    <div class="text-center">
                        <div class="">
                            <h4>Sản phẩm không tồn tại <br> Vui lòng kiểm tra lại từ khoá</h4>
                        </div>
                    </div>
